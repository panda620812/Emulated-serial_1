...
__NO_RETURN void thread_w5500 (void *argument)
{
	osDelay (1000);
...
//		else if(W5500_Send_Delay_Counter >= 300)//定时发送字符串
//		{
...
void Load_Net_Parameters(void)
{
	...
	S0_DPort[0] = 0x0F;//加载端口0的目的端口号4000
	S0_DPort[1] = 0xA0;
...
//    Rx_Buffer[size] = 0;
//    sprintf((char*)Tx_Buffer, "%s : %s\r\n" ,DateTimeNow, Rx_Buffer);
//	size = strlen((char*)Tx_Buffer);
//	Write_SOCK_Data_Buffer(s, Tx_Buffer, size);
//}

void W5500_Interrupt_Check( void )
{
	if(GPIO_ReadInputDataBit(W5500_INT_PORT, W5500_INT) == RESET)
	{
		W5500_Interrupt=1;
	}
}
